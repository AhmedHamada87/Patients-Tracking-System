...
namespace taghzia
{
    public partial class editvisita : Form
    {
        ...
        public editvisita()
        {
            ...
            var opa = Application.OpenForms["visita"] as visita;
        ...
        private void editvisita_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            cmd.ExecuteNonQuery();
            con.Close();
            var apol = Application.OpenForms["visita"] as visita;
            apol.loadvisita();
            Close();
        }
