...
namespace taghzia
{
    public partial class vistaaddgad : Form
    {
        ...
        public vistaaddgad()
        {
            ...
            var bdm = Application.OpenForms["visitafromgad"] as visitafromgad;
        ...
        private void vistaaddgad_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var apo = Application.OpenForms["visitafromgad"] as visitafromgad;
                apo.loadvisita();
                Close();
